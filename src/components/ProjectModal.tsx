            ...
            <div className="p-6 border-b border-white/5 flex justify-between items-center bg-white/5">
              <div>
                ...
                <div className="flex gap-4 mt-1">
                  <span className="text-[10px] font-mono text-gray-400 uppercase tracking-widest">Version: 1.0.0</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="relative aspect-video lg:aspect-auto bg-rbr-navy overflow-hidden">
                ...
                <div className="absolute inset-4 border border-white/5 rounded backdrop-blur-3xl flex flex-col items-center justify-center">
                   ...
                   <span className="text-[10px] tracking-[0.3em] text-rbr-yellow/50">DATA RENDERING ACTIVE</span>
                </div>
              </div>
              ...
              <div className="p-8 space-y-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
                <section>
                  <h4 className="text-[10px] font-black tracking-[0.2em] text-rbr-red uppercase mb-3 flex items-center gap-2">
                    <span className="w-4 h-[1px] bg-rbr-red" /> Mission Objective
                  </h4>
                ...
                <section>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.stack.map((tech) => (
                      <span key={tech} className="glow-pill px-3 py-1 bg-rbr-red/5 rounded-full text-[10px] font-bold text-white uppercase tracking-wider">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                <section>
                  <h4 className="text-[10px] font-black tracking-[0.2em] text-rbr-red uppercase mb-3 flex items-center gap-2">
                    <span className="w-4 h-[1px] bg-rbr-red" /> Performance Metrics
                  </h4>
                  <div className="grid grid-cols-2 gap-4">
                    {project.metrics.map((metric) => (
                      <div key={metric.label} className="bg-white/5 p-4 rounded-sm border border-white/5 hover:border-rbr-yellow/30 transition-all">
                        <span className="block text-[10px] font-mono text-gray-500 uppercase mb-1">{metric.label}</span>
                        <span className="text-xl font-black italic tracking-tighter text-rbr-yellow">{metric.value}</span>
                      </div>
                    ))}
                  </div>
                </section>
                ...
                <div className="pt-6 flex flex-col sm:flex-row gap-4 border-t border-white/5">
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    ...
                    >
                      {project.links.githubBackend ? "Frontend Code" : "Inspect Source"} <Github size={14} />
                    </a>
